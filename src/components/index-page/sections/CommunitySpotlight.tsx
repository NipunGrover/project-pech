...
export function CommunitySpotlight() {
  const spotlights = [
    {
      title: "The Plan to End Chronic Homelessness (PECH) Committee meeting notes",
    ...
    },
    {
      ...
      description: "Updates coming soon after our last meeting to finalize bus passes for individuals experiencing homelessness",
      action: "View more",
    ...
    },
    {
      ...
      description: "Quarterly meetings with representatives shared insights of the journey home for those experiencing homelessness",
      action: "View more",
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-12">
          ...
          <TypographyLead className="text-gray-600">
            We couldn&apos;t do it alone. Learn about the community partners making an impact.
          </TypographyLead>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {spotlights.map((spotlight, index) => (
            <Card key={index} className="overflow-hidden border-gray-200">
              ...
              <CardContent>
                <CardDescription className="mb-4">{spotlight.description}</CardDescription>
                <Button 
                  variant={spotlight.actionVariant}
                  className={spotlight.actionVariant === "secondary" ? "bg-purple-100 text-purple-700 hover:bg-purple-200" : ""}
                >
                  {spotlight.action}
                </Button>
              </CardContent>
